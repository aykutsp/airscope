...
|-------------|:-----:|--------------------------------|-------------------------------|
| Linux       | 1.75+ | `gcc` + `make`                 | `libpcap-dev` (or -devel)     |
| macOS       | 1.75+ | Xcode Command Line Tools       | `brew install libpcap`        |
| Windows MSVC| 1.75+ | VS 2022 Build Tools (C++)      | Npcap runtime + SDK           |
| Windows GNU | 1.75+ | mingw-w64 (e.g. WinLibs)       | Npcap runtime + SDK (+ rename)|
